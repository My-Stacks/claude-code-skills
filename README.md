...
| [copilot-scoring](./.claude/skills/copilot-scoring/) | Skill | 1.0 | Evaluate a project's suitability for GitHub Copilot code review. Standardized rubric with weighted scoring across 5 dimensions. |
