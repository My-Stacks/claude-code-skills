...
| [design-qa-lite](./.claude/skills/design-qa-lite/) | Skill | 1.0 | Portable Markdown design QA for a deployed web URL: responsive layout, accessibility, Core Web Vitals, and SEO basics. Runs in any agent with skills support (Cursor, Codex, Gemini CLI, or Claude Code without the design-qa plugin). Lighter than the full design-qa plugin, same workflow. |
