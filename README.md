...
| [pr-watch](./.claude/skills/pr-watch/) | Skill | 1.0 | Monitor a GitHub PR and notify on reviews, comments, check changes, merge, or closure. Polls via CronCreate every 30 minutes. |
