...
| [prod-readiness-audit](./.claude/skills/prod-readiness-audit/) | Skill | 1.0 | Read-only audit of any codebase across four buckets — infra/security/compliance, engineering, design/UX, and product analytics — returning a red/yellow/green scorecard and the single highest-priority fix. Accepts an optional path argument to scope to a subdirectory. |
